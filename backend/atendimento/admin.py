...
class MostraAtendimento(admin.ModelAdmin):
    list_display = ('id', 'data', 'hora', 'servico', 'descricao',
                    'tipo', 'idfuncionario', 'idcliente')
    list_display_links = ('id', 'data', 'hora', 'servico',
                          'descricao', 'tipo', 'idfuncionario', 'idcliente')
    list_filter = ('id', 'data', 'hora', 'servico', 'descricao',
                   'tipo', 'idfuncionario', 'idcliente')
    list_per_page = 15
